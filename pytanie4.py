...
sim.create_signal([[6, 17], [18]], {'slow_factor': 0.3})
sim.create_signal([[1, 12]], {'slow_factor': 0.3})
sim.create_signal([[28, 31, 47]], {'slow_factor': 0.3})
...
sim.create_gen({
    'vehicle_rate': 30,
    'vehicles': [
        [3, {'path': [0, 1, 2, 3, 4, 5, 6, 7, 8, 22, 29 ,30, 31, 32], 'v_max': 12}],
        [1, {'path': [18, *road(48 + 15), 15, 14, 13, 12, 11, 10, 9],'v_max': 12}],
        [3, {'path': [18, *road(48), 8, 21],'v_max': 12}],
        [4, {'path': [28, 27, 26, 25, 23, 17, 16, 15, 14, 13, 12, 11, 10, 9], 'v_max': 12}]
    ]}
)
...
sim.create_gen({
    'vehicle_rate': 2,
    'vehicles': [
        [4, {'path': [0, 1, 2, 35, 33, 34, 36, 37, 38, 39, 40,6, 7, 8, 41, 42, 43, 44, 45, 46, 47, 32], 'l': 8, 'v_max': 8}]
    ]}
)
